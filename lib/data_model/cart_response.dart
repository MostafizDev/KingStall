...
class CartResponse {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "cart_items": cart_items == null
            ? null
            : List<dynamic>.from(cart_items.map((x) => x.toJson())),
      };
}
...
class CartItem {
  ...
  factory CartItem.fromJson(Map<String, dynamic> json) => CartItem(
        ...
        product_thumbnail_image: json["product_thumbnail_image"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
        ...
        "product_thumbnail_image":
            product_thumbnail_image == null ? null : product_thumbnail_image,
